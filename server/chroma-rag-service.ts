    ...
    try {
      ...
      this.regulationData = [
        ...
        },
        {
          ...
          content: "사업주는 고압 또는 특고압 전기설비의 설치·정비·점검 등의 업무를 하는 근로자에 대하여는 전기 관련 자격을 취득한 자 또는 해당 업무에 관한 안전보건교육을 받은 자로 하여금 작업하게 하여야 한다.",
          category: "전기작업자격"
        },
        {
          title: "제319조(정전작업)",
        ...
        },
        {
          ...
          content: "사업주는 절연용 보호구, 절연용 방호구, 활선작업용 장치 및 기구를 사용하는 경우에는 그 절연성능을 점검한 후 사용하게 하여야 한다.",
          category: "전기보호구"
        },
        // 기존 일반 안전 조항들 - 원문 기준
        {
