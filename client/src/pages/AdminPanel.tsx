...
export default function AdminPanel() {
  ...
  const handleEditEquipment = (equipment: Equipment) => {
    ...
    editForm.reset({
      ...
      highVoltageDetails: equipment.highVoltageDetails || "",
      highPressureRisk: equipment.highPressureRisk || false,
      highPressureDetails: equipment.highPressureDetails || "",
      highTemperatureRisk: equipment.highTemperatureRisk || false,
      highTemperatureDetails: equipment.highTemperatureDetails || "",
